...
<script type="text/javascript">
	$(function(){
		...
		$("#openSearchActivityBody").click(function () {
		...
		$("#convertBtn").click(function () {
			var checkState=$("#isCreateTransaction")[0].checked
			if(checkState){
				$("#TranForm").submit();
			}else {
...
<body>
	...
	<div id="create-transaction2" style="position: relative; left: 40px; top: 20px; width: 80%; background-color: #F7F7F7; display: none;" >
		...
		<form id="TranForm" action="workbench/clue/convert.do" method="POST">
		  ...
		  <div class="form-group" style="width: 400px;position: relative; left: 20px;">
		    <label for="activityName">市场活动源&nbsp;&nbsp;<a href="javascript:void(0);"  id="openSearchActivityBody" style="text-decoration: none;"><span class="glyphicon glyphicon-search"></span></a></label>
